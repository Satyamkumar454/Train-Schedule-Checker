# Train_schedule
'''
After input train number, train schedule is open.
'''
import requests
class IRCTC:
    ...
    def fetch_data(self, train_no):
        data =requests.get("https://indianrailapi.com/api/v2/TrainSchedule/apikey/b01e399916a4c12b51a797b298a12d23/TrainNumber/{}".format(train_no))
